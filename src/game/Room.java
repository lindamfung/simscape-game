...
public class Room {
	...
	public Room getPrevRoom() {return prev;}
	public Room getNextRoom() {return next;}
	public ItemContainer<Item> getAllItems() {return allItems;}
	public boolean getIsDoorLocked() {return isDoorLocked;}
	public ItemContainer<Item> getInspectedFurniture() {return inspectedFurniture;}

	// Setter methods
	public void setLevel(int roomLevel) {level = roomLevel;}
	public void setDescription(String roomDescription) {description = roomDescription;}
	public void setPrevRoom(Room prevRoom) {prev = prevRoom;}
	public void setNextRoom(Room nextRoom) {next = nextRoom;}
	public void setAllItems(ItemContainer<Item> allRoomItems) {allItems = allRoomItems;}
	public void setIsDoorLocked(boolean lockStatus) {isDoorLocked = lockStatus;}
