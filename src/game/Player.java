...
/**
 * The Player class creates a player with an inventory, total number of levels completed
...
public class Player {
	...
	private ItemContainer<Item> inventory = new ItemContainer<Item>(); // Inventory to hold items found
	...
	public ItemContainer<Item> getInventory() {return inventory;}
	
	// Setter methods
	public void setName(String playerName) {name = playerName;}
	public void setCurrentRoom(Room room) {currentRoom = room;}
	public void setLevelsCompleted() {levelsCompleted++;}
	
	/**
	 * This method is used when player unlocks the current room. The player advances 
	 * to the next room, the total number of levels completed is incremented, and 
