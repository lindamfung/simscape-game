...
/**
 * The FurnitureItem class creates an item that can be found in a room. This item can either hold a puzzle, 
 * tool, or reveal a clue on inspection.
 * 
 * Author: Linda Fung
 * Date: 05-17-2020
 * Course: CS622
...
public class FurnitureItem extends Item {
	...
	public Item getHiddenItem() {return hiddenItem;}
