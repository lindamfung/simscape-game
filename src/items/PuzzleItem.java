...
/**
 * The PuzzleItem class creates an puzzle that can be found in a room or inside furniture. A puzzle can
 * be solved by entering a solution or using a tool. A puzzle will contain a key or a clue.
 * 
 * Author: Linda Fung
 * Date: 05-17-2020
 * Course: CS622
...
public class PuzzleItem extends Item {
	...
	public boolean getIsPuzzleSolved() {return isPuzzleSolved;}
	
	// Setter methods
	public void setPuzzleSolution (String solution) {puzzleSolution = solution;}
	public void setItemContained (Item contained) {itemContained = contained;}
	public void setIsPuzzleSolved(boolean puzzleSolvedStatus) {isPuzzleSolved = puzzleSolvedStatus;}
	...
	/**
	 * This method is used when a player inspects a puzzle item and if it hasn't been solved,
	 * prints the description to the console. Otherwise, state that it has already been solved.
	 */
	@Override
	public void onInspect() {
		...
		} else System.out.println(this.getDescription());
	}
